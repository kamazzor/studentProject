...
//Каждый элемент списка содержит инфу про 1 персону типа AnswerCityRegisterItem, включая информацию о том, кого проверяли ,какой результат проверки
...
public class AnswerCityRegister {
    ...
    public void addItem(AnswerCityRegisterItem item){
        if (items == null){
            List<AnswerCityRegisterItem> items = new ArrayList<>(10);
        }
        items.add(item);
    }
